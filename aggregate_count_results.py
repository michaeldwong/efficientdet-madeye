...
def main():
    ...
    #            for no in generate_neighboring_orientations(best_fixed_orientation):
    ...
    #                if object_type == 'car':
    #                    orientation_to_latest_count[no] = len(actual_total_cars_list)
    #                elif object_type == 'person':
    #                    orientation_to_latest_count[no] = len(actual_total_people_list)
...
#                result_str += f'{o}:{orientation_to_car_count[o]},'
            ...
            print('orientation to model rank ', orientation_to_model_ranking)
            print('orientation to latest rank ', orientation_to_latest_ranking)
